...
// SUBMIT QUIZ
// NOTE: Quiz score ONLY affects learner trust score.
// Mentor's payment is NOT tied to quiz result — that would be unjust.
// The quiz is purely for learner's verification and trust building.
router.post('/submit', authMiddleware, async (req, res) => {
  try {
    ...
    const score = Math.round((correct / (questions?.length || 5)) * 100);
